...
👉 [点击查看各稳定IPTV直播源套餐详情](https://docs.qq.com/doc/DVnRrb3JhSGFVT3NR)（[备用地址](https://app.notion.com/p/wwkjs/IPTV-380bbe97ed4580959c77c842e5b75111?source=copy_link)、[备用地址2](https://share.note.youdao.com/s/DOoxI0We)）（其他套餐，请看左侧文档，介绍更全面）

### 300+频道稳定套餐详情

- 常用频道：汇聚了 300 多个优质频道，涵盖国内外新闻时事、影视娱乐、体育赛事、纪录片、少儿教育等各类精彩内容，满足全家不同的观影需求。
- 注意：每个订阅账户仅限 `1` 个设备数播放，`不能同时超过 2 个设备打开播放`，请勿随意分享，否则可能被系统自动封禁。
- **不支持切换套餐，请看准后下单购买。**
- 支持 `APTV`（Apple TV） 、Televizo、Tivimate（有 Xtream Codes 协议的软件）
- 3 条对于不同运营商的优化线路
- **XSTREAM CODES 登录**，非 m3u 订阅地址（m3u 订阅地址可看下面 `国内频道 m3u 套餐`）
...
| 常用频道类目 | 月卡（30天）                                                 | 半年卡（180天）                                              | 年卡（360天）                                                |
| ------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
...
- [北京卫视全频道直播源](https://www.wangdu.site/software/av-read/339.html)
...
- [migu PHP 源码压缩包](https://pan.quark.cn/s/ac839c323391)：部署到自己服务器解压，使用PHP8.0+版本，直接访问IP:5080进入配置好即可，自定义域名那里就写`http://IP:5080`，然后保存，然后更新数据，伪静态可以不用设置，直接就能观看了
- [PHP源码](https://pan.quark.cn/s/79fe34d75ff5) ：使用方法在PHP文件中有备注，使用的缓存需要启用APCu扩展，小白不懂的直接使用站长的Docker PHP管理面板就能直接观看，ID需要自己找（来源：[bbs](https://bbs.livecodes.vip/forum.php?mod=viewthread&tid=550)）
...
[rtp2httpd](https://github.com/stackia/rtp2httpd) 是一个多媒体流转发服务器。本项目是 [oskar456/rtp2httpd](https://github.com/oskar456/rtp2httpd) 的完全重构版本，在原项目基础上加入了许多新功能，专为中国大陆 IPTV 环境设计。
...
[Browser Stream Bridge](https://github.com/yelixoea/browser-stream-bridge) 一个 **将视频网站中 `<video>` 元素的数据实时转发为 HLS 流** 的 Node.js 服务，基于 **Playwright + MediaRecorder + FFmpeg + 内置 HTTP Server**。
...
[TeleList](https://www.wangdu.site/software/av-read/339.html) 是一款体积小巧的直播源转换工具，它的界面简单、操作也很简单，主要作用是用于转换直播源、创建播放源列表。TeleList 支持格式转换，重复检查等等多种功能，还能使用 TeleList 轻松制作 VLC、Potplay 视频播放器的播放列表格式。

### flybird-iptv

[flybird-iptv](https://www.wangdu.site/software/av-read/339.html) 是一款iptv检查器，系统支持：MacOS、Windows

### M3U Link Tester

[M3U Link Tester](https://www.wangdu.site/software/av-read/339.html) 是一个简单而有效的工具，用于测试M3U文件中链接的有效性。该工具具有用户友好的界面，支持通过拖放方式导入M3U文件，快速测试其中包含的多个链接。
...
2026年44款最新电视家替代品，电视TV直播软件：[更多自带直播源的APP，无需配置直播源，下载即可使用](./IPTV-自带源-替代电视家直播的APP.md)（[VIP版](https://www.wangdu.site/software/av-read/339.html)）
...
[DongYuTVWeb](https://pan.quark.cn/s/2564b037214a)（1.0.6.5） 轻松在电视上观看直播，操作简单，适合家中老人使用，使用 WebView JavaScript 注入方式实现，全新网页直播电视，涵盖多种电视频道，永不失效

- 高Android版本电视请下载名称里面带WebView的版本（体积小，系统内核）
- 设备比较老的请下载名称带X5的版本，使用的X5内核，可能只支持Android13以下版本，并且需要是64位设备。

### 魄狼TV

[魄狼TV_1.0.1](https://www.wangdu.site/software/av-read/339.html) 作为一款专为智能电视设计的视频直播软件，提供了中央频道、地方卫视、网络频道等多种选择，让用户能够自由选择观看内容，而且所有内容均免费提供观看，让用户体验最极致的电视观看体验，快来下载体验吧。

主要有央视、卫视、地方台、新闻、动漫、教育、国际等分类频道。

### 直播大全电视app

[直播大全电视app](https://www.wangdu.site/software/av-read/339.html) 是一款可以看电视直播的影音播放类软件，这款软件不仅可以看央视、卫视，还可以看地方台，都是直播，点击就能看，无需等待，同时软件内还没有广告，让用户在这里享受极致的电视体验，这款软件不仅可以在手机上使用，还可以在电视上使用哦。

### 我们的电视

[我们的电视](https://www.wangdu.site/software/av-read/339.html)：电视直播软件，安装即可使用，高清，超清，蓝光，完全免费，您再也不用费劲巴力的找各种不稳定的直播源了。更有节目单回看强大功能秒杀市面上各类XXXPTV（回看功能需要赞赏才能使用）
...
[极悦直播](https://www.wangdu.site/software/av-read/339.html)可免费畅享央视、卫视和地方台，还有精彩影视作品。拥有2000+频道！无论是综艺、体育、热门影视等，应有尽有，您想看的都可以在这里找到！播放流畅稳定，超清影院级画质，给您带来非凡观看体验！
...
[电视大全TV版app](https://www.wangdu.site/software/av-read/339.html)（版本号：1.3.8）是一款转为电视打造的追剧平台，央视、卫视、地方等频道都可以在这里观看，用户可以根据喜好自由观看心仪的频道节目，时事新闻、经典老剧、搞笑综艺等等都可以流畅观看。（`APP 内弹出的二维码，按返回键取消即可`）
...
[QMPlay2](https://github.com/zaps166/QMPlay2) 是一个视频和音频播放器。它可以播放 FFmpeg、libmodplug（包括 J2B 和 SFX）支持的所有格式。它还支持音频 CD、原始文件、Rayman 2 音乐和芯片曲调。它包含 YouTube 和 MyFreeMP3 浏览器。

![QMPlay2](https://cdn.wwkejishe.top/wp-cdn-02/2025/20250630134527660.webp)

### SFVIP-Player

[SFVIP-Player](https://github.com/austintools/SFVIP-Player) IPTV 播放器 是一款功能强大的媒体播放器，可让您轻松享受各种音频和视频格式。它旨在为用户提供无缝的播放体验，支持各种媒体文件类型并提供卓越的性能。使用 SFVIP-Player，您可以以前所未有的方式深入研究您最喜爱的电影、电视节目、音乐和在线内容。

- 优化音频和视频设置：尝试播放器的音频和视频设置，以增强您的观看和聆听体验。调整均衡器、视频过滤器和音频输出设置以适合您的喜好。
- 使用键盘快捷键：SFVIP Player X 64 IPTV Player 提供了一系列键盘快捷键，可以提高您在播放器中的工作效率和导航。熟悉这些快捷键，以便更高效地控制播放、调整音量和执行其他作。
- 创建智能播放列表：利用 SFVIP Player X 64 IPTV Player 播放列表管理功能。根据流派、艺术家或评级等标准创建智能播放列表，以自动组织媒体库。
- 启用自动字幕：如果您经常观看外国电影或带字幕的视频，请在 SFVIP Player X 64 IPTV Player 中启用自动字幕下载。此功能会自动搜索和下载媒体文件的字幕，从而节省您的时间和精力。

### 云影空蒙

[云影空蒙](https://pan.quark.cn/s/ae67460312a5)（[使用文档](https://www.yuque.com/morishizaizuoshimoni/yykm/vghn0bubm1m8tt97?singleDoc)）是一款专为影视爱好者设计的电视直播TV应用。虽然此版本为空壳版，不自带任何资源，但用户可以通过自定义添加直播源的方式，自由配置想要观看的内容。支持测试开机自启，可以设置为默认进入设置页或直接进入直播界面。播放体验流畅，提供高清画质，是打造个性化电视直播平台的理想选择。

![云影空蒙最新版本](https://cdn.wwkejishe.top/wp-cdn-02/2026/20260204202032421.png)

## TVBox介绍

[TVBox Android TV版](https://www.wangdu.site/software/av-read/339.html) 是 GitHub 的一个开源项目，完全免费，通过配置接口就可以实现完美支持TV的电视直播和影视点播。
...
[下载地址](https://www.wangdu.site/software/av-read/339.html)（[VIP版：软件+点播源](https://www.wangdu.site/software/av-read/339.html)）
...
[智能电视安装TVBox/影视仓方法](https://www.wangdu.site/software/av-read/339.html)

## 不同品牌电视机顶盒和电视机安装第三方应用软件的安装方法

[不同品牌电视机顶盒和电视机安装第三方应用软件.md](./IPTV-不同品牌电视机顶盒和电视机安装第三方应用软件.md)
...
### 为什么电视直播源限制手机播放/为什么所有的电视直播源都限制手机

各省、市、自治区广播电视台，拥有本台电视卫星频道、地面频道及所有频道包含的电视节目的广播权、信息网络传播权（原始取得或经授权获得）和广播组织权，同时有权禁止他人未经许可，以有线或无线方式转播、录制复制或通过信息网络向公众传播。各广播电视台的新媒体机构拥有本台的合法授权。所以其他渠道算是进行违规播放当地直播的内容，算是违规的！所以目前各大直播APP都会被清退。

### 多源播同一频道如何编辑

1. 使用直播源列表工具 TeleList 编辑
2. [xteve-project/xTeVe: M3U Proxy for Plex DVR and Emby Live TV](https://github.com/xteve-project/xTeVe) xTeVe 是一个 IPTV 管理工具，它的主要功能有合并多个 M3U 文件，合并多个 XMLTV 文件，自动更新 M3U 和 XMLTV 文件，导出 M3U 和 XMLTV 文件，可以过滤频道，可以修改频道的名称、台标、分组、排序、分类等信息，可以给每个频道单独设置节目单，可以设置缓存，可以接入 Plex 和 Emby，还有更多其他功能。（[使用教程](https://blog.csdn.net/u010567698/article/details/129341065)）

### 把mytv安装到电视盒子

1. 直接通过U盘拷贝进去安装

2. 小米电视可以使用小米电视助手进行安装

3. 如电视可以启用ADB，也可以通过ADB进行安装

   ```shell
   adb install my-tv.apk
   ```

4. 通过开心电视助手（在下面获取）远程安装

### 在小米电视机中安装，提示违反互联网法律法规，禁止安装。如何能安装？

[小米电视安装第三方 apk 应用提示存在违规功能](https://blog.kobin.cn/blog/system/s4/2941.html)

### 部分频道无法播放或经常卡顿，如何解决？

频道无法播放可能有以下原因：

- 网络环境不稳定，建议使用有线网络或更换网络环境
- 部分频道需要 IPv6 环境，请确保您的网络支持 IPv6
- 源站可能暂时性故障，可以稍后重试或切换到其他线路
- 播放软件不支持该视频格式，建议使用推荐的播放器

### 为什么有些频道画质较差或者有延迟？

直播源画质和延迟受多种因素影响：源站带宽、传输线路、编码格式等。建议优先使用 M3U 格式的直播源，其中包含了高清频道和最新的 EPG 信息。如遇到特定频道问题，可以尝试切换不同时段收看。

### 如何判断我的网络是否支持 IPv6？

可以访问 [test-ipv6.com](https://test-ipv6.com/) 进行检测。如果显示有 IPv6 地址，则表示您的网络支持 IPv6。国内三大运营商目前都已支持 IPv6，如果无法访问 IPv6 频道，请联系您的网络服务商开通 IPv6 功能。

### M3U 和 TXT 格式有什么区别？

A: M3U 格式是专业的播放列表格式，支持频道分组、台标显示和 EPG 节目信息，推荐使用。TXT 格式仅包含基础的频道信息，适合定制化使用或者快速测试。
...
- 检查播放器是否支持 EPG 显示功能
- 尝试手动刷新 EPG 数据
- 某些频道可能暂时没有 EPG 数据，属于正常现象

## 开心电视助手【最新版】安卓TV必备的神器

![开心电视助手【最新版】安卓TV必备的神器！](https://cdn.wwkejishe.top/wp-cdn-02/2024/202411190955687.webp)

 开心电视助手，是一款专门针对安卓设备打造的远程管理工具，有了这个软件就可以非常方便管理自己的智能设备了，可以轻松实现：管理电视/机顶盒/投影仪等设备，还可以远程安装各种电视APP，方便用户的使用和安装应用，还支持刷第三方固件等等。功能非常强大！

### 特色功能

1. 图形化操作，小白也能轻松管理智能电视、电视盒子、投影仪等安卓设备；
2. 便捷安装第三方 APK，远程截图，虚拟遥控器，一键去广告，优化系统，更加稳定流畅，支持刷第三方 ROM 固件；
3. 支持自定义加载 bat 批处理、py 脚本等插件,比如免拆批量刷盒子，一键备份机顶盒系统固件;

### 界面展示

1. 支持远程投屏

   ![开心电视助手【最新版】安卓TV必备的神器！-远程投屏](https://cdn.wwkejishe.top/wp-cdn-02/2024/202411190953129.webp)

   ![开心电视助手【最新版】安卓TV必备的神器！-远程投屏](https://cdn.wwkejishe.top/wp-cdn-02/2024/202411190955911.webp)

2. 虚拟遥控

   ![开心电视助手【最新版】安卓TV必备的神器！-虚拟遥控](https://cdn.wwkejishe.top/wp-cdn-02/2024/202411190956194.webp)



3. 删除内置软件（`强调一下：完全不懂的小白朋友，慎重操作`，由于开心电视助手非常强大，取得相应权限后，夸张的说，可以任意修改。所以大家慎重使用。）开心电视助手非常强大，有基础的朋友，可以做更多的尝试。但是对于小白来说，用它删除一下电视自带的软件，删除开机广告，更换电视默认的桌面还是非常不错的。

   ![开心电视助手【最新版】安卓TV必备的神器！-删除内置软件](https://cdn.wwkejishe.top/wp-cdn-02/2024/202411190956021.webp)

### 开心电视助手下载

最新版下载链接：【[点击下载](https://www.wangdu.site/software/av-read/339.html)】

### 更新列表

6.2 版本更新说明

- 0x01 修复中文路径，出现未知错误问题；
- 0x02 支持瑞芯微芯片。

6.0 版本更新说明

- 0x01 重写核心代码，兼容Android 4.4～14版本；
- 0x02 全新的应用管理器，可显示应用图标，更准确显示应用安装位置，新增一键生成精简系统脚本，导出所有应用信息；
- 0x03 优化自定义脚本逻辑，更简单添加自定义脚本，新增海思、晶晨、晨星、国科芯片备份功能；
- 0x04 更新投屏模块,支持主流电视、投影、机顶盒快速投屏，可自定义投屏参数；
- 0x05 更新虚拟遥控器模块，可以独立运行；
- 0x06 软件正常运行需安装Visual C++ 2008运行库及 .NET Framework 4.8.1 运行环境，仅支持Windows 7 以上64位系统版本。
...
[我的电视（mytv-android）](https://www.wangdu.site/software/av-read/339.html) : 使用 Android 原生开发的电视直播软件
...
[我的电视（my_tv）](https://www.wangdu.site/software/av-read/339.html) 使用Flutter开发的电视直播软件
...
...
- 新增 开心电视助手6.2版本By剑心
- IPTV直播源播放工具（自带源）新增 我的电视（my_tv：mytv我的电视安卓版.apk、 mytv我的电视直播TV版.apk）

### 2024年11月12日

- IPTV直播源播放工具（自带源） 新增 野火直播
- TVBox系列客户端 新增 闪电侠(EasyBox)

### 2024年11月11日

- 在线IPTV源（博主自维护） 新增 IPV4源
- IPTV直播源（需直播源） - 黑鸟播放器 新增网盘下载

### 2024年11月10日

- IPTV直播源（需直播源） 新增 PotPlayer v1.7.22347绿色版

### 2024年11月7日

- 新增 TVBox使用教程
- 更新 IPTV源精细版（Github仓库）

### 2024年10月30日

- IPTV直播源、EPG接口（精选）更新 已测试直播源

### 2024年10月17日

- 更新 目录结构
- IPTV源播放工具（自带源） 新增 WebView 电视

### 2024年10月16日

- 精选IPTV源、EPG接口 新增 已测试本地直播源
...
- IPTV、APTV 直播源 m3u - 国(台港澳) IPTV直播源M3U 增加 新的IPTV源
- 精选IPTV源、EPG接口 新增 博主自维护在线IPTV源
...
IPTV，即互联网协议电视（Internet Protocol Television），是一种通过互联网协议来提供包括电视节目在内的多种数字媒体服务的技术。以下是关于 IPTV 的一些基本概念和相关知识：

### 定义

IPTV 是基于互联网协议，通过宽带网络向用户提供电视节目、视频内容和其他多媒体服务的技术。与传统的有线电视或卫星电视不同，IPTV 利用互联网传输数据，用户可以通过网络访问各种电视节目和视频内容。

### 原理

IPTV的工作原理是通过互联网将视频流从提供商的服务器传输到最终用户的机顶盒。与传统电视通过电缆发送模拟信号不同，IPTV通过托管的专用互联网网络发送模拟信号。IPTV具有用于存储内容的服务器，使用户可以自由地随意观看节目。

1. 用户请求观看特定节目，IPTV提供商接收该请求。
2. 提供商处理请求并将视频流从其服务器传输到用户。
3. 内容流通过安全的专用网络传输到用户端的网关。
4. 内容通过实时流协议（RTSP）以数据包的形式传送到播放设备，然后对其进行压缩以优化播放。

### 特点

1. **连续的视频流**：IPTV提供专业制作的内容，如电视广播网络送来的，具有成百个不停止、连续播出的频道。
2. **统一的内容形式**：所有通道共享一种压缩方式和使用同一个码率。
3. **在专用网上传输**：与互联网视频在公共互联网上传播不同，IPTV服务几乎是通过专用网进行传输的。
4. **通过机顶盒在家庭电视机上观看**：IPTV机顶盒将进入的IPTV信号变换成标准的视频信号，以供家中电视机显示。
5. **多样化的内容**：IPTV可以提供丰富多样的电视节目和视频内容，包括电影、电视剧、体育赛事、新闻、娱乐节目等。
6. **交互性和按需性**：与传统电视不同，IPTV提供了更多的交互性和按需性，用户可以根据需要随时点播自己感兴趣的节目或视频。
7. **时移和回放**：IPTV支持时移播放功能，用户可以在节目正在播放的同时进行暂停、快进、后退等操作。
8. **多屏互动**：IPTV可以与其他设备进行互联，例如智能手机、平板电脑和电脑等，实现多屏互动和共享观看体验。
9. **网络传输**：IPTV利用IP网络传输数据，可以通过宽带接入实现高清画质和流畅的视频播放。

### 与OTT的区别

- IPTV采用独立组网，而OTT叠加在宽带网上。
- IPTV有QoS保障，而OTT无。
- IPTV各地广电提供节目源，有电视直播，而OTT无。

这些是IPTV的基本概念和相关知识，它通过互联网协议提供电视服务，具有多种优势，包括高质量的视频流、丰富的内容选择、交互性和灵活性。
